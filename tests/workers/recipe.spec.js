...
describe('workers > recipe worker', () => {
  ...
  it('loads and filters custom recipes correctly', async () => {
    let input = [
      {output_item_id: -1, ingredients: [{item_id: 5}], disciplines: ['Mystic Forge']},
      {output_item_id: 2, ingredients: [{item_id: -5}], disciplines: ['Mystic Forge']},
      {output_item_id: 3, ingredients: [{item_id: 5}], disciplines: ['Mystic Forge']},
      {output_item_id: 4, ingredients: [{item_id: 4}], disciplines: ['Mystic Forge']},
      {output_item_id: 38023, ingredients: [{item_id: 38024}], disciplines: ['Mystic Forge']},
      {output_item_id: 38116, ingredients: [{item_id: 6}], disciplines: ['Mystic Forge']},
      {output_item_id: 5, ingredients: [{item_id: 6}], disciplines: ['Achievement']},
      {output_item_id: 6, ingredients: [{item_id: 99}], disciplines: ['Merchant']}
    ]
    let output = [
      {output_item_id: 3, ingredients: [{item_id: 5}], disciplines: ['Mystic Forge']},
      {output_item_id: 5, ingredients: [{item_id: 6}], disciplines: ['Achievement']}
